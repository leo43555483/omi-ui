  ...
  methods: {
    ...
    bindTouchEvent: function bindTouchEvent() {
      ...
      this.$nextTick(function () {
        ...
        dom.on(_this2.scoller, 'touchstart', _this2.onTouchStart);
        dom.on(_this2.scoller, 'touchmove', _this2.onTouchMove, false);
        dom.on(_this2.scoller, 'touchend', _this2.onTouchEnd);
      });
    },
    unBindTouchEvent: function unBindTouchEvent() {
      ...
      if (scoller) {
        dom.off(scoller, 'touchstart', this.onTouchStart);
        dom.off(scoller, 'touchmove', this.onTouchMove);
        dom.off(scoller, 'touchstart', this.onTouchEnd);
        this.scoller = null;
      }
    },
