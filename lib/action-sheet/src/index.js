...
var index$1 = require('../../loading/src/index.vue.js');
var index$2 = require('../../icon/src/index.vue.js');
  ...
  return {
    ...
    methods: {
      handleCancel: function handleCancel(e) {
        ...
        if (shared.isFunction(onCancel)) onCancel(e);else this.$emit('input', false);
      },
