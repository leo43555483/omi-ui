...
var panel = require('../../mixins/panel.js');
var provider = require('../../mixins/provider.js');
var bar = require('./mixins/bar.js');
var shared = require('../../utils/shared.js');
var index = require('../../badge/src/index.vue.js');
...
var script = {
  ...
  mixins: [touch["default"], panel["default"], bar["default"], provider["default"]('tabsParent')],
  data: function data() {
    return {
  ...
  methods: {
    ...
    setActive: function setActive(_ref3) {
      ...
      if (shared.unDef(activeKey) || shared.unDef(activeIndex)) return;
