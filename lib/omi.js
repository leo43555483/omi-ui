(function (global, factory) {
  ...
  var overLayMixin = {
    ...
    methods: {
      ...
      mountOverlay: function mountOverlay() {
        ...
        var OverlayConstructor = Vue__default["default"].extend(OverLay());
        var el = document.createElement('div');
  ...
  var ImagePreview$1 = function ImagePreview() {
    return {
  ...
  var VueImagePreview = ImagePreview$1();
