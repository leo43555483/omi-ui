(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue-runtime-helpers/dist/normalize-component.js'), require('async-validator'), require('@vue/babel-helper-vue-jsx-merge-props'), require('vue')) :
  typeof define === 'function' && define.amd ? define(['vue-runtime-helpers/dist/normalize-component.js', 'async-validator', '@vue/babel-helper-vue-jsx-merge-props', 'vue'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.omi = factory(global.__vue_normalize__, global.AsyncValidator, global._mergeJSXProps, global.Vue$1));
})(this, (function (__vue_normalize__, AsyncValidator, _mergeJSXProps, Vue$1) { 'use strict';
  ...
  function mergeVNodeHook (def, hookKey, hook) {
    ...
    if (isUndef(oldHook)) {
      ...
      /* istanbul ignore if */
      if (isDef(oldHook.fns) && isTrue$1(oldHook.merged)) {
  ...
  function applyNS (vnode, ns, force) {
    ...
    if (isDef(vnode.children)) {
      for (var i = 0, l = vnode.children.length; i < l; i++) {
        ...
        if (isDef(child.tag) && (
          isUndef(child.ns) || (isTrue$1(force) && child.tag !== 'svg'))) {
  ...
  function resolveAsyncComponent (
    ...
    if (isTrue$1(factory.error) && isDef(factory.errorComp)) {
    ...
    if (isTrue$1(factory.loading) && isDef(factory.loadingComp)) {
  ...
  function createPatchFunction (backend) {
    ...
    function invokeInsertHook (vnode, queue, initial) {
      ...
      if (isTrue$1(initial) && isDef(vnode.parent)) {
    ...
    function hydrate (elm, vnode, insertedVnodeQueue, inVPre) {
      ...
      if (isTrue$1(vnode.isComment) && isDef(vnode.asyncFactory)) {
        vnode.isAsyncPlaceholder = true;
        return true
      }
      // assert node match
