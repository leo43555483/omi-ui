...
var PickerColums = function PickerColums() {
  return {
    name: 'OmiPickColums',
    mixins: [inject["default"]('omiPicker'), touch["default"]],
    data: function data() {
      return {
        currentIndex: 0,
        currentDuration: 0,
    ...
    methods: {
      ...
      getValidDefaultIndex: function getValidDefaultIndex(index) {
        return shared.unDef(this.data[index]) ? 0 : index;
      },
      ...
      setTransform: function setTransform(moveY) {
        ...
        this.transformY = shared.getRange(offset, itemHeight, -(dataLength * itemHeight));
      },
      ...
      scrollTo: function scrollTo(offset, currentIndex, cb) {
        ...
        var scrollCallBack = function scrollCallBack() {
          ...
          if (shared.isFunction(cb)) cb();
        };

        if (!this.inited || shared.isFunction(cb)) {
      ...
      getValidIndex: function getValidIndex(index) {
        return shared.getRange(Math.round(index), this.dataLength - 1, 0);
      },
    ...
    mounted: function mounted() {
      ...
      this.$nextTick(function () {
        if (!_this3.bindedEvent) {
          _this3.bindTouchEvent(dom.on, true);
        }
    ...
    beforeDestroy: function beforeDestroy() {
      if (this.bindedEvent) this.bindTouchEvent(dom.off, false);
    },
...
exports.MAX_VISIBLE_ITEM = MAX_VISIBLE_ITEM;
exports["default"] = Colums;
