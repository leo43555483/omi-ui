<template>
  <div class="cell">
    ...
    <omi-cell title="title3" label="label1" rightArrow>
      <omi-input slot="content" readonly placeholder="请输入文字" />
    </omi-cell>
    <omi-cell-group title="cell group" description="配合cellgroup使用">
...
<script>
import { Cell, CellGroup, Button, Input } from 'omi'
export default {
  name: 'CellDemo',
  data () {
    return {}
