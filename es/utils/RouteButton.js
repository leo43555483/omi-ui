  ...
  return {
    ...
    methods: {
      ...
      createRouteTag: function createRouteTag(child) {
        ...
        return h("RouterLink", _mergeJSXProps([{}, props, {
          "class": tagClass
        }]), [child]);
      },
...
export { ACTIVECLASS, APPEND, EVENT, EXACT, EXACTACTIVECLASS, REPLACE, TAG, TO, RouteButton$1 as default, routeButtonProps };
